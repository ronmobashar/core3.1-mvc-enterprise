...
namespace PandasPizzaShop.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> ManageClaimsForUser(string userId)
        {
            ...
            var claimsManagementViewModel = new ClaimsManagementViewModel { UserId = user.Id, AllClaimsList = PandasPizzaShopClaimTypes.ClaimsList };
        ...
        public async Task<IActionResult> ManageClaimsForUser(ClaimsManagementViewModel claimsManagementViewModel)
        {
           ...
           //_userManager.AddClaimsAsync(user, claim);
           // user.Add(claim);
            var result = await _userManager.UpdateAsync(user);
